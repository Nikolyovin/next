    ...
    return (
        <section className='z-0 relative md:h-[50vh] xl:h-[100%]'>
            <Element name='contactMeTop'>
                <Image className='object-cover h-[110%] md:h-[50vh] xl:h-[100vh]' src={bg1} alt='photo' />
                {/* <NeedEntrySlider /> */}
                <div className='absolute z-100  h-full  top-0 px-[20px] py-[25px]'>
                    <h3 className='title text-white flex-1 mb-5'>Что нужно для записи?</h3>
                    <div className='flex flex-col justify-between'>
                        <p className=' text-white mb-[5px]  md:mb-4 text-[16px] md:text-[20px]'>
