      ...
      <div className=' bg-white  z-1 '>
        <div className='px-4 bg-white'>
          ...
          <p className='mt-3 mb-2 text-slate-500'>
            Привет! Меня зовут Виктория и я мастер тату. Также я являюсь членом
            Ассоциации Художников Ботанического Искусства. Я очень люблю
            ботанику, и через свои работы чувствую гармонию с природой.
          </p>
          <p className='mt-3 mb-6 text-slate-500'>
            Я люблю создавать красоту на теле своих клиентов и заряжать их своей
            энергией.Мои любимые стили - это ботаника и микрореализм. Если вы
            хотите добавить что-то особенное в свою жизнь, давайте создадим это
            вместе!
          </p>
        </div>
